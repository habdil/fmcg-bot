...
from telegram_bot.handlers.ask_handler import analyze, free_text_analysis
...
def build_application() -> Application:
    ...
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, free_text_analysis))
    return application
